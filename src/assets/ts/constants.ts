...
export const THERAPY_MARKS: ITherapyMark[] = [
    {
        ...
        description:
            'Терапия для тех, кого ни перед чем не остановить. Дается за сбор жетонов терапии: Пукатон 2025, Групповая терапия или Ветеран фильмотерапии, Сеанс лудомании, Клипная лоботомия и Донатотерапия',
    },
    {
